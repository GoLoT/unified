...
{
public:
    Combat(NWNXLib::ViewPtr<NWNXLib::Services::HooksProxy> hooker);
...
private:
    ...
    static int32_t CNWSCreature__ResolveDefensiveEffects(NWNXLib::API::CNWSCreature *thisPtr, NWNXLib::API::CNWSObject *pTarget, int32_t bHit);
    ...
    static void CNWSCreature__ResolveRangedAttack(NWNXLib::API::CNWSCreature *thisPtr, NWNXLib::API::CNWSObject *pTarget,
                                                   int32_t nNumAttacks, int32_t a4);
    static void CNWSCreature__ResolvePostRangedDamage(NWNXLib::API::CNWSCreature *thisPtr, NWNXLib::API::CNWSObject *pTarget);
    ...
    static void CNWSCreature__ResolvePostMeleeDamage(NWNXLib::API::CNWSCreature *thisPtr,
                                                      NWNXLib::API::CNWSObject *pTarget);
    static int32_t CNWSCreatureStats__GetDamageRoll(NWNXLib::API::CNWSCreatureStats *thisPtr, NWNXLib::API::CNWSObject *pTarget,
    ...
    static int32_t CNWSObject__DoDamageImmunity(NWNXLib::API::CNWSObject *thisPtr, NWNXLib::API::CNWSCreature *pAttacker,
                                                 int32_t nDamage, uint16_t nFlags, int32_t bSimulate,
                                                 int32_t bCombatDamage);
    static int32_t CNWSObject__DoDamageReduction(NWNXLib::API::CNWSObject *thisPtr, NWNXLib::API::CNWSCreature *pAttacker,
                                                  int32_t nDamage, unsigned char nDamagePower, int32_t bSimulate,
                                                  int32_t bCombatDamage);
    static unsigned char CNWSCreature__CalculateDamagePower(NWNXLib::API::CNWSCreature *thisPtr, NWNXLib::API::CNWSObject *pTarget,
                                                             int32_t bOffhand);
